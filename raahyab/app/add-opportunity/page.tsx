...
export default function AddOpportunityPage() {
  ...
  <div className="flex flex-col lg:flex-row gap-8 items-stretch">
      <OpportunityForm onSubmit={handleCreate} submitLabel="Publish Opportunity" />

      <div className="w-full lg:w-[360px] shrink-0 rounded-3xl border border-dashed border-foreground/15 p-8 lg:sticky lg:top-24">
